...
<Tabs queryString="onglet">
    ...
    <TabItem value="pile" label="Pile d'appels">
        ...
        Le fonctionnement (Principe LIFO)
        ...
        L'empilement : Quand une instruction appelle une fonction, Python met le programme actuel sur pause et dépose la nouvelle fonction au sommet de la pile.

        Priorité au sommet : Python ne peut faire qu'une seule chose à la fois. Il travaille toujours sur la fonction qui se trouve tout en haut de la pile.

        Le retour : Dès que la fonction au sommet a terminé son travail, elle est retirée de la pile. Python reprend alors le travail sur la fonction qui se trouve juste en dessous, exactement là où il l'avait laissée.
