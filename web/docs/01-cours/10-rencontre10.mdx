---
title: 10 - Graphiques, collections
...
import Mod_ForSequence from '../_cours-modules/_for-sequence.mdx';
    ...
    <TabItem value="Activités" label="Activités">
        ...
        <Tabs>
	        ...
	        <TabItem value="2" label="Activités à faire en classe">
                ...
                Créez un fichier `r10_virus_liste_simple.py` pour votre réponse.
                ...
                Créez un fichier `r10_virus_listes_paralleles.py` pour votre réponse.
                ...
                Créez un fichier `r10_virus_liste_2d.py` pour votre réponse.
                ...
                Créez un fichier `r10_comprehension_liste.py` pour votre réponse.
                ...
                Créez un fichier `r10_ensembles.py` pour votre réponse.
                ...
                Créez un fichier `r10_dictionnaires_imbrique.py` pour votre réponse.
                ...
                Créez un fichier `r10_jeu_devinette_ameliore.py` pour votre réponse.
                ...
                Créez un fichier `r10_graphique_courbe_simple.py` pour votre réponse.
                ...
                Créez un fichier `r10_graphique_temperatures_annuelles.py` pour votre réponse.
                ...
                Créez un fichier `r10_graphique_barres_moyennes.py` pour votre réponse.
                ...
                Créez un fichier `r10_graphique_populations_saison.py` pour votre réponse.
                ...
                **REMARQUES**
                ...
                📁 Créez un fichier `r10_graphique_nuage_courbe.py` pour votre réponse.
                ...
                **N'exécutez pas le code avant d'avoir terminé votre dessin !**
                ...
                Créez un fichier `r10_graphique_main.py` pour valider votre réponse en exécutant le code.
                ...
                **N'exécutez pas le code avant d'avoir terminé vos réponses !**
                ...
                Créez un fichier `r10_comprehension_set.py` pour valider votre réponse en exécutant le code.
                ...
                **N'exécutez pas le code avant d'avoir terminé vos réponses !**
                ...
                Créez un fichier `r10_comprehension_dict.py` pour valider votre réponse en exécutant le code.
