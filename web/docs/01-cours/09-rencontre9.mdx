    ...
    <TabItem value="Activités" label="Activités">
        ...
        <Tabs>
	        ...
	        <TabItem value="2" label=" 🏫 Activités à faire en classe">
                ...
                Malgré sa stupidité, vous devez quand même lui indiquer si la bonne réponse est plus haute ou plus basse!
                ...
                **Étape 1 - Tracer une seule plante**
                ...
                Vérifiez que votre graphique ressemble aux mesures de la première plante avant de continuer.
                ...
                **N'exécutez pas le code avant d'avoir terminé votre dessin !**
                ...
                📁 Créez un fichier `r09_graphique_main.py` pour valider votre réponse en exécutant le code.
                ...
                **N'exécutez pas le code avant d'avoir terminé vos réponses !**
                ...
                📁 Créez un fichier `r09_comprehension_set.py` pour valider votre réponse en exécutant le code.
                ...
                **N'exécutez pas le code avant d'avoir terminé vos réponses !**
                ...
                📁 Créez un fichier `r09_comprehension_dict.py` pour valider votre réponse en exécutant le code.
