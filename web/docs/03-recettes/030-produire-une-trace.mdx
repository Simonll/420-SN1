...
Pour plus de détails sur le placement de points d'arrêt et l'utilisation du débogueur, voir la recette [Déboguer et points d'arrêt](/recettes/deboguer-point-arret).
