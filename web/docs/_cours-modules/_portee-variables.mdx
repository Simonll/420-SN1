...
Lorsqu'une variable locale et une variable globale partagent le même nom, la version locale **masque** (shadows) la version globale au sein de sa portée. Elle ne la modifie pas, elle la cache simplement.
